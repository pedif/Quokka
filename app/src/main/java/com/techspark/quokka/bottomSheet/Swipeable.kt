package com.techspark.quokka.bottomSheet
...
import com.techspark.quokka.bottomSheet.SwipeableDefaults.StandardResistanceFactor
import com.techspark.quokka.bottomSheet.SwipeableDefaults.VelocityThreshold
import com.techspark.quokka.bottomSheet.SwipeableDefaults.resistanceConfig
...
internal data class FractionalThreshold(
    ...
    override fun Density.computeThreshold(fromValue: Float, toValue: Float): Float {
        return lerp(fromValue.toDp(), toValue.toDp(),fraction).toPx()
    }
}
